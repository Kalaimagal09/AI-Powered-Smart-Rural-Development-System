...
## ⚙️ Tech Stack
* **Data Processing & Modeling:** Advanced Excel, SQL Server[cite: 1]
* **Data Wrangling & Automation:** Python (Pandas)[cite: 1]
* **Exploratory Data Analysis (EDA):** Matplotlib, Seaborn, Plotly[cite: 1]
* **Statistical Analysis:** Scipy, Statsmodels (ANOVA, Chi-square, Regression)[cite: 1]
* **Business Intelligence:** Microsoft Power BI, DAX[cite: 1]
...
* **Executive Navigation:** Slicers and bookmarks allowing seamless toggling between "Infrastructure Growth" and "Social Indicators"[cite: 1].
* **Deep-Dive Drill-Throughs:** Interactive capabilities allowing users to jump from state-level overviews directly to district-wise performance metrics[cite: 1].
* **Dynamic KPIs:** Real-time tracking of critical metrics such as the "% of Villages with Clean Water" and the "Top 5 Developing Districts"[cite: 1].
